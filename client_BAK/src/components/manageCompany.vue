            ...
            <div class="entryRow form-group">
                <table class="table  table-striped table-dark" >
                   <thead class="thead-dark">
                    ...
                    <tbody >
                    <tr v-for="firma in Firmen" v-bind:key="firma.id"> 
...
export default {
    ...
    methods: {
        async updateAllData() {
            //this.Firmen = await DBService.DBgetCompanys("all"); 
            this.Firmen = await DBService.DBget("Firmen","all");   
            this.newCompany = ""
        ...
        async AddCompany() {
            ...
            await DBService.AddCompany(_newCompany);
            this.updateAllData()
        },
